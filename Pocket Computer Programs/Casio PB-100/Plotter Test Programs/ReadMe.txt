...
This translation feature allows pocket computers such as the PB-100 (and similar models) to use the plotter emulation feature in the PCUI and/or real plotters connected to the PCUI.
